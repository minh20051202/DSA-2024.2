...
class TestDebtCycleSimplifier(unittest.TestCase):
    ...
    def test_simple_cycle_detection(self):
        """Test detection of simple cycles with interest rates."""
        simplifier = AdvancedDebtCycleSimplifier(self.transactions, self.current_date)
    ...
    def test_multiple_cycles(self):
        """Test detection of multiple cycles with different dates."""
    ...
    def test_cycle_with_penalty_fees(self):
        """Test cycle detection with penalty fees."""
        ...
        # Verify penalty fees are considered in cycle detection
        for tx in simplified:
            if tx.penalty_fee > 0:
    ...
    def test_empty_transactions(self):
        ...
        simplifier = AdvancedDebtCycleSimplifier(empty_transactions, self.current_date)
        simplified = simplifier.simplify()
    ...
    def test_single_transaction(self):
        ...
        simplifier = AdvancedDebtCycleSimplifier(single_transaction, self.current_date)
        simplified = simplifier.simplify()
    ...
    def test_large_network_cycles(self):
        """Test cycle detection in large network."""
        ...
        simplifier = AdvancedDebtCycleSimplifier(large_transactions, self.current_date)
        simplified = simplifier.simplify()
    ...
    def test_disconnected_components(self):
        """Test cycle detection in disconnected components."""
        ...
        # Verify cycle detection constraints
        for tx in simplified:

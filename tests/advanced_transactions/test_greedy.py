...
class TestGreedySimplifier(unittest.TestCase):
    ...
    def test_optimal_solution_with_interest(self):
        ...
        simplifier = AdvancedGreedySimplifier(self.transactions, self.current_date)
    ...
    def test_empty_transactions(self):
        ...
        simplifier = AdvancedGreedySimplifier(empty_transactions, self.current_date)
        simplified = simplifier.simplify()
    ...
    def test_single_transaction(self):
        ...
        simplifier = AdvancedGreedySimplifier(single_transaction, self.current_date)
        simplified = simplifier.simplify()
    ...
    def test_large_network_optimization(self):
        """Test optimization with large network."""
        ...
        simplifier = AdvancedGreedySimplifier(large_transactions, self.current_date)
        simplified = simplifier.simplify()

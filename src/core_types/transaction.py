...
class AdvancedTransaction:
    ...
    def get_debt_breakdown(self, current_date: date) -> Dict[str, float]:
        """
        Lấy breakdown chi tiết của nợ tại thời điểm hiện tại.
        
        Returns:
            Dict chứa thông tin chi tiết về gốc, lãi, phí phạt và tổng
        """
